...
const formatTime = (time: Date, type = '3'): string | null => {
    if (!time) return null
    let str = ''
    switch (type) {
        // yyyy-mm-dd hh:MM:ss
...
function padStart2(num: number | string = 0) {
    num = typeof num === 'string' ? num : String(num)
    return num.padStart(2, '0')
}

// 防抖函数
function debounce (cb: Function, wait: number = 100, immediate: boolean = false) {
...
export { marked, formatTime, fetch, debounce }
